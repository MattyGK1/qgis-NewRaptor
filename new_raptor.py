...
/***************************************************************************
 ...
 Generated by Plugin Builder: http://g-sherman.github.io/Qgis-Plugin-Builder/
        ...
        begin                : 2022-03-23
        git sha              : $Format:%H$
        copyright            : (C) 2022 by M.R.Little
        email                : MATTYISFATTY@OUTLOOK.COM
 ***************************************************************************/
...
class NewRaptor:
    ...
    def initGui(self):
        ...
        self.add_action(
            icon_path,
            text=self.tr(u'Add New Rator Nest'),
            callback=self.run,
    ...
    def run(self):
        ...
        if result:
            ...
            QMessageBox.information(self.dlg, "Message", "Should Only Run If everything is okay\n New Nest ID: {}\n\nLatitude: {}\nlongitude: {} \n Species: {} \n Buffer: {} \n Status: {} \n Last Survaied: {}".format(valNestID,valLat,valLng,valSpecies,valBuffer,valStatus,valLast))
            ...
            buffer = geom.buffer(valBuffer, 13)
            ftrNest.setGeometry(buffer)
            pr.addFeatures([ftrNest])
            lyrBuffer.reload()
        else:
            QMessageBox.information(self.dlg, "Message", "Should Run If Plugin Unexpectatly closes")
